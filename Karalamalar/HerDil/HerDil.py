...
##################################################################
    ...
    for SayfaNumarasi in range(1, taranacakSayfa+1):
        URL = 'https://www.discudemy.com/all/{}'.format(SayfaNumarasi)
        ...
        for DiscudemyLinkler in soup.findAll('a', attrs={'href': re.compile("^https://www.discudemy.com/")}): ## https://stackoverflow.com/questions/26274724/filtering-urls-obtained-using-beautifulsoup
